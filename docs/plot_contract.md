...
- Description: Nature: a compact research-figure style that prioritizes official constraints.
...
- `curve`: `small_panel_width_mm`=60.0, `small_panel_height_mm`=55.0, `direct_label_max_series`=4, `legend_candidate_order`=['upper_right', 'lower_right', 'upper_left', 'lower_left'], `legend_candidate_bias_step`=0.75, `tensile_legend_candidate_order`=['lower_right', 'upper_right', 'lower_left', 'upper_left'], `tensile_legend_candidate_bias_step`=25.0, `compact_direct_label_inset_fraction`=0.04, `compact_direct_label_offset_pt`=4.0, `compact_direct_label_search_band_fraction`=0.12, `compact_tick_width_scale`=0.82, `compact_tick_length_scale`=0.88, `compact_legend_max_series`=3, `compact_legend_columns`=2, `compact_legend_font_scale`=0.92, `compact_legend_handlelength`=1.35, `compact_legend_handletextpad`=0.35, `compact_legend_columnspacing`=0.8, `compact_legend_borderpad`=0.15, `compact_legend_candidate_order`=['upper_center', 'upper_right', 'lower_right', 'upper_left', 'lower_left', 'lower_center'], `compact_legend_candidate_bias_step`=0.75, `tensile_compact_legend_candidate_order`=['lower_right', 'upper_right', 'lower_left', 'upper_left', 'upper_center', 'lower_center'], `tensile_compact_legend_candidate_bias_step`=25.0, `legend_area_ratio_warn`=0.055, `legend_area_ratio_fail`=0.07, `dense_marker_point_threshold`=24, `dense_markevery_min`=2, `dense_markevery_max`=6, `dense_marker_scale`=0.88, `dense_tick_width_scale`=0.85, `dense_tick_length_scale`=0.9, `dense_line_width_scale`=0.96, `stroke_hierarchy_target`=0.3, `label_collision_margin_px`=3.0
- `heatmap`: `small_panel_width_mm`=60.0, `small_panel_height_mm`=55.0, `colorbar_x_offset_fraction`=0.29, `colorbar_width_fraction`=0.56, `colorbar_y_offset_fraction`=0.2, `colorbar_height_fraction`=0.1, `colorbar_tick_count`=4, `label_gap_pt`=6.0, `min_label_gap_px`=6.0, `safe_sequential_palettes`=['colorblind_safe', 'deep', 'muted', 'bright', 'mono', 'infographic', 'roma', 'macarons', 'okabe_ito', 'tol_muted', 'materials_warm', 'shine', 'vintage']
