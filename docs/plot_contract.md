...
- `curve`: `small_panel_width_mm`=60.0, `small_panel_height_mm`=55.0, `direct_label_max_series`=4, `legend_area_ratio_warn`=0.055, `legend_area_ratio_fail`=0.07, `dense_marker_point_threshold`=24, `dense_markevery_min`=2, `dense_markevery_max`=6, `dense_marker_scale`=0.88, `dense_tick_width_scale`=0.85, `dense_tick_length_scale`=0.9, `dense_line_width_scale`=0.96, `stroke_hierarchy_target`=0.3, `label_collision_margin_px`=3.0
