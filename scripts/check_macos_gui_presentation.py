...
PRESENTATION_CHECKS: tuple[SourceCheck, ...] = (
    ...
    SourceCheck(
        label="Fit model selection uses visual cards instead of picker popups",
        path="app/macos/Sources/Shared/UI/FitModelGrid.swift",
        required=(
    ...
    SourceCheck(
        label="Data Studio analysis fit reuses card model selection",
        path="app/macos/Sources/Features/DataStudio/DataStudioAnalysisSheet.swift",
        required=(
            "FitModelGrid(",
            "session.updateAnalysisFitModel",
