...
- Data Studio v2 `curve_metrics` templates carry `comparison_enabled`. `false` means curve-only workbook output (`DataStudio_Metadata + All_Curves`); `true` keeps representative/metric compare sheets.
