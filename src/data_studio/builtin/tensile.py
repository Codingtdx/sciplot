...
def export_tensile_replicate_workbook(
    ...
    *,
    ...
    metadata_sheet = _metadata_sheet_dataframe(
    ...
    with pd.ExcelWriter(workbook_path) as writer:
        ...
        metadata_sheet.to_excel(writer, sheet_name=METADATA_SHEET, header=False, index=False)
    ...
    return DataStudioWorkbook(
        ...
        sheet_names=tuple(sheet_name for sheet_name, _ in sheets) + (METADATA_SHEET,),
